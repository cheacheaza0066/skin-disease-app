...
class _MainSkinState extends State<MainSkin> {
  ...
  detectimage(File image) async {
    var prediction = await Tflite.runModelOnImage(
      ...
      ///เปอร์เซ็นความตรง เอาเรื่มตั้งเเต่กี่เปอร์เซ็นต์
      imageMean: 127.5,
      imageStd: 127.5,
                      ...
                      ? Container(
                          child: Column(
                            children: [
                              ...
                              _output.isEmpty
                                  ? Text(
                                      'รูปภาพไม่ตรงกับโรคใดๆ อัพโหลดอีกครั้ง')
                                  : Text("ผลการทำนาย - "+
                                      (_output[0]['label'])
                                          .toString()
                                          .substring(0),
                      ...
                      ? SingleChildScrollView(
                          child: Column(
                            children: _output.isNotEmpty
                                ? _output.map((result) {
                                  double n = result["confidence"]*100;
                                    return Container(
                                      child: Padding(
                                        ...
                                        child: Text(
                                          ...
                                          "${result["label"]} - ${n.toStringAsFixed(0)}%",
